...
export default {
  ...
  methods: {
    ...
    open: function () {
      ...
      if (
        !(typeof this.date[this.namePointer - 1] === "undefined") &&
        !(typeof this.sender[this.namePointer - 1] === "undefined")
      ) {
        console.log(this.date[this.namePointer - 1]);
        console.log(this.sender[this.namePointer - 1]);
        var emailName =
          this.date[this.namePointer - 1] + this.sender[this.namePointer - 1];
